<script lang="ts">
    ...
    const isUSD =
        (quote?.co_mone || "").toUpperCase().includes("US") ||
        (quote?.co_mone || "").includes("$");
    ...
    const displayFecVenc = quote?.fec_us_mo
        ? quote.fec_us_mo
        : quote?.fec_venc || quote?.fec_emis;

    const cleanObs = String(quote?.comentario || "")
            ...
            <div class="print-container">
                ...
                <div class="info-grid">
                    <div class="client-box">
                        ...
                        <p class="client-rif">
                            RIF: {quote?.cli_rif || quote?.rif || quote?.co_cli}
                        </p>
                        <p class="client-address font-medium">
                            DIRECCIÓN: {quote?.cli_dir ||
                                quote?.direc1 ||
                                "Dirección no registrada"}
                        </p>
                        {#if quote?.cli_tel || quote?.telefonos}
                            <p
                                class="client-phone font-bold mt-1 text-slate-700"
                            >
                                TELÉFONO: {quote?.cli_tel || quote?.telefonos}
                            </p>
                        {/if}
                    ...
                    <div class="logistic-box">
                        ...
                        {#if quote?.trans_des || quote?.co_tran}
                            <div class="info-row">
                                <span class="label">Transporte:</span>
                                <span class="val"
                                    >{quote?.trans_des || quote?.co_tran}</span
                                >
                            </div>
                        {/if}
                        {#if quote?.n_control}
                            <div class="info-row">
                                ...
                                <span class="val">{quote?.n_control}</span>
                            </div>
                        {/if}
                    </div>
                </div>
                        ...
                        <div class="footer-grid">
                            <div class="remarks">
                                ...
                                <div class="disclaimer mt-1">
                                    <p>
                                        * Esta cotización es referencial. Sujeto
                                        a cambios sin previo aviso según tasa
                                        del día.
                                    </p>
                                    <p>
