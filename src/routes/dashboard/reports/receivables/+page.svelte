...
<div class="space-y-8" in:fade>
    ...
    {#if data.cxc?.metrics}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5" in:slide>
            
            <!-- Card 1: Cartera Total -->
            <div class="bg-surface-raised border border-border-subtle hover:border-brand-500/30 transition-all rounded-3xl p-5 relative overflow-hidden group">
                <div class="absolute right-0 top-0 w-28 h-28 bg-brand-500/5 rounded-full blur-2xl group-hover:bg-brand-500/10 transition-colors"></div>
                <div class="flex items-center justify-between mb-3">
                    <div class="p-2 rounded-xl bg-brand-500/10 text-brand-700 dark:text-brand-400 border border-brand-500/20">
                        <Wallet size={20} />
                    </div>
                </div>
                <p class="text-text-muted text-[11px] font-bold uppercase tracking-wider mb-0.5">Saldo Total</p>
                <p class="text-2xl sm:text-3xl font-black text-text-base tracking-tight">{formatCurrency(metrics.total_outstanding_usd, 'USD')}</p>
                <p class="text-[10px] text-text-muted font-bold mt-1.5 line-clamp-1">{formatCurrency(metrics.total_outstanding_bs, 'VES')}</p>
            </div>

            <!-- Card 2: Cartera Vencida -->
            <div class="bg-surface-raised border border-border-subtle hover:border-red-500/30 transition-all rounded-3xl p-5 relative overflow-hidden group">
                <div class="absolute right-0 top-0 w-28 h-28 bg-red-500/5 rounded-full blur-2xl group-hover:bg-red-500/10 transition-colors"></div>
                <div class="flex items-center justify-between mb-3">
                    <div class="p-2 rounded-xl bg-red-500/10 text-red-700 dark:text-red-400 border border-red-500/20">
                        <TrendingDown size={20} />
                    </div>
                </div>
                <p class="text-text-muted text-[11px] font-bold uppercase tracking-wider mb-0.5 text-red-600 dark:text-red-400">Saldo Vencido</p>
                <p class="text-2xl sm:text-3xl font-black text-red-600 dark:text-red-400 tracking-tight">{formatCurrency(metrics.total_overdue_usd, 'USD')}</p>
                <p class="text-[10px] text-text-muted font-bold mt-1.5 line-clamp-1">{formatCurrency(metrics.total_overdue_bs, 'VES')}</p>
            </div>
            ...
            <div class="bg-surface-raised border border-border-subtle hover:border-emerald-500/30 transition-all rounded-3xl p-5 relative overflow-hidden group">
                ...
                <p class="text-text-muted text-[11px] font-bold uppercase tracking-wider mb-0.5 text-emerald-600 dark:text-emerald-400">Saldo por Vencer</p>
                <p class="text-2xl sm:text-3xl font-black text-emerald-600 dark:text-emerald-400 tracking-tight">{formatCurrency(metrics.total_upcoming_usd, 'USD')}</p>
                <p class="text-[10px] text-text-muted font-bold mt-1.5 line-clamp-1">{formatCurrency(metrics.total_upcoming_bs, 'VES')}</p>
            </div>
            ...
            <div class="bg-surface-raised border border-border-subtle hover:border-blue-500/30 transition-all rounded-3xl p-5 relative overflow-hidden group">
                ...
                <p class="text-text-muted text-[11px] font-bold uppercase tracking-wider mb-0.5">Documentos Activos</p>
                <p class="text-2xl sm:text-3xl font-black text-text-base tracking-tight">{metrics.doc_count}</p>
                <p class="text-[10px] text-text-muted font-bold mt-1.5 line-clamp-1">Facturas / Notas de Débito</p>
            </div>
